...
<html>
    ...
    <body>
        <div class="bgImg">
			...
			<br><br>
			<div align="center">
				<a class="navLinkNextPage" href="4medical_inquiryhtml.php"><img class="navImg" src="./3img/reservation.jpg" width="60%"></a>
			</div>
			<br><br>
			<div align="center">
			...
			<br><br>
			<div align="center">
				<a class="navLinkNextPage" href="7indexhtml.php"><img class="navImg" src="./3img/navigate.jpg" width="60%"></a>
			</div>
			<br><br>
			<div align="center">
				<a class="navLinkNextPage" href="./8progress/progress1html.php"><img class="navImg" src="./3img/percent.jpg" width="60%"></a>
			</div>
			<br><br>
            <?php
				} else {
